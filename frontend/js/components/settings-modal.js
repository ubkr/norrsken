...
export class SettingsModal {
            ...
            <div id="settingsModal" class="modal-overlay" style="display: none;">
                <div class="modal-content">
                    ...
                    <div class="location-info">
                        <p class="location-name">Click map to select location</p>
                        <p class="coordinates">Lat: --, Lon: --</p>
                        <p class="warning" style="display: none;">⚠️ Outside Sweden - data may be less accurate</p>
                    </div>
                    <div class="modal-actions">
                        <button class="btn-cancel">Cancel</button>
                        <button class="btn-save" disabled>Save Location</button>
                    </div>
                </div>
            </div>
        `;
    ...
    resetForm() {
        ...
        this.locationName.textContent = 'Click map to select location';
    ...
    onLocationSelected(location) {
        ...
        if (!location.name) {
            this.locationName.textContent = 'Loading location name...';
        }
    }
